...
from .filesystem import JSONStorage, DirJSONsStorage, TasksJSONStorage, CompletionsDirStorage, ExternalTasksJSONStorage, ShelveStorage
...
register_storage("shelve", ShelveStorage)
